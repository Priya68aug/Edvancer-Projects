...
ld_train=read.csv("F:/bank-full_train.csv",stringsAsFactors = F)

ld_test= read.csv("F:/bank-full_test.csv",stringsAsFactors = F)
...
rg_train=read.csv("F:/rg_train.csv",stringsAsFactors = FALSE)
rg_test=read.csv("F:/rg_test.csv",stringsAsFactors = FALSE)
...
ci_train=read.csv("F:/census_income.csv",
                  stringsAsFactors =F)
glimpse(ci_train)
